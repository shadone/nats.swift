...
/// explicit ``stop()``.
public final class ObjectStoreWatcher: AsyncSequence {
    ...
    /// succeeds. `nil` before ``start()`` and after a failed one.
    ...
    internal func start() async throws {
        ...
        pumpTask = Task { [consumer, continuation, client, ignoreDeletes, updatesOnly] in
